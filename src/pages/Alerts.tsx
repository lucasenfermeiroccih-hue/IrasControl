...
import { Bell, AlertTriangle, ShieldAlert, CheckCircle, ArrowUpRight, Loader2, Download, ChevronLeft } from "lucide-react";
...
const Alerts = () => {
  ...
  useEffect(() => { setPage(1); }, [filterSeverity, filterStatus]);
